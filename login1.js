document.addEventListener("DOMContentLoaded", function () {
    ...
    userIcon.addEventListener("mouseover", function () {
        // Fjern eksisterende dropdownMenu, hvis den allerede findes
        ...
        dropdownMenu.style.display = "block"; // Gør den synlig direkte ved hover
        ...
        // Skjul dropdown-menu, når musen forlader området
    ...
    style.innerHTML = `
        #dropdownMenu {
            ...
            box-shadow: 0px 8px 16px rgba(0, 0, 0
document.addEventListener("DOMContentLoaded", function () {
    const userIcon = document.getElementById("userIcon");
